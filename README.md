...
VITE_GOOGLE_ADS_QUOTE_CONVERSION_LABEL=AbCdEfGhIjkLmNoPqRs
VITE_LINKEDIN_PARTNER_ID=123456
VITE_LINKEDIN_QUOTE_CONVERSION_ID=12345678
VITE_META_PIXEL_ID=123456789012345
VITE_META_QUOTE_EVENT_NAME=Lead
VITE_MICROSOFT_UET_TAG_ID=123456789
...
NETLIFY_AUTH_TOKEN=... npm run apply:marketing-platform-env:netlify -- --env-file ./marketing.env
```
