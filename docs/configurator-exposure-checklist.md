...
2026-07-12, the latest Configurator behavior change
`e80d468b2038f140808fa5f1a8165c9985020933` is verified live.
...
Search Console performance reporting is readable. For the 2026-04-10 through 2026-07-08 window, `npm run report:search-console -- --days=90 --row-limit=50` returned 34 configurator/solution rows, including impressions for `/configurator/`, `/configurator/28/`, `/configurator/29/`, `/solutions/gpu-server-quote/`, `/solutions/h200-vs-rtx-pro-6000/`, `/solutions/nvidia-h200-server/`, `/solutions/rtx-pro-6000-workstation/`, and the new `/solutions/comino-grando-configurator-taiwan/` route.
