...
const HomeSolutionsSection: React.FC<HomeSolutionsSectionProps> = ({ isEnglish }) => {
  const items = [
    ...
    { icon: Blocks, href: '/solutions/headless-saas', title: isEnglish ? 'Enterprise headless SaaS' : '企業 Headless SaaS', body: isEnglish ? 'Connect existing systems to branded portals, event workflows, controlled AI agents, and governance.' : '串接既有系統，建立品牌入口、事件流程、受控 AI Agent 與治理。', accent: 'amber', color: 'bg-amber-400/15 text-amber-300 hover:border-amber-300/60' },
