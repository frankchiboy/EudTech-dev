...
const CareersPage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead
        title={
          isEnglish ? "Careers - Join Our Team" : "職業機會 - 加入我們的團隊"
        }
        description={
          isEnglish
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900">
        <main className="pt-16">
          <section className="relative flex min-h-[420px] items-center justify-center overflow-hidden bg-slate-950">
            <img
              src={EDITORIAL_PHOTOGRAPHY.careerConversation.src}
              alt={
                isEnglish
                  ? EDITORIAL_PHOTOGRAPHY.careerConversation.alt.en
                  : EDITORIAL_PHOTOGRAPHY.careerConversation.alt.zh
              }
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              {jobData.map((job) => (
                <Card
                  ...
                  variant="elevated"
                  padding="lg"
                  className="border border-gray-200 dark:border-gray-700 scroll-mt-24"
                >
                  {/* Job Title */}
                  <div className="mb-8">
                  ...
                  <details className="group mb-5 rounded-xl border border-gray-200 p-5 dark:border-gray-700">
                    <summary className="flex cursor-pointer list-none items-center justify-between gap-4 [&::-webkit-details-marker]:hidden">
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white flex items-center">
                        <span className="mr-2 text-sm font-semibold text-green-700 dark:text-green-300">01</span>
                        {isEnglish ? "Job Responsibilities" : "工作內容"}
                      </h3>
                      <span className="text-sm font-semibold text-blue-600 dark:text-blue-300 group-open:hidden">
                        {isEnglish ? "View" : "展開"}
                      </span>
                      <span className="hidden text-sm font-semibold text-blue-600 dark:text-blue-300 group-open:inline">
                  ...
                  <details className="group mb-8 rounded-xl border border-gray-200 p-5 dark:border-gray-700">
                    <summary className="flex cursor-pointer list-none items-center justify-between gap-4 [&::-webkit-details-marker]:hidden">
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white flex items-center">
                        <span className="mr-2 text-sm font-semibold text-orange-700 dark:text-orange-300">02</span>
                        {isEnglish ? "Requirements" : "條件需求"}
                      </h3>
                      <span className="text-sm font-semibold text-orange-600 dark:text-orange-300 group-open:hidden">
                        {isEnglish ? "View" : "展開"}
                      </span>
                      <span className="hidden text-sm font-semibold text-orange-600 dark:text-orange-300 group-open:inline">
                        {isEnglish ? "Collapse" : "收合"}
                      </span>
                    </summary>
                    <ul className="mt-5 space-y-3">
                  ...
                  <div className="text-center pt-6 border-t border-gray-200 dark:border-gray-700">
                    <Button
                      onClick={() =>
                        handleApply(isEnglish ? job.title.en : job.title.zh)
                      }
                      variant="primary"
                      size="lg"
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  <img src={EDITORIAL_PHOTOGRAPHY.workflowDesign.src} alt="" className="mx-auto mb-4 h-20 w-full max-w-56 rounded-xl object-cover" loading="lazy" decoding="async" aria-hidden="true" />
                ...
                <div className="text-center">
                  <img src={EDITORIAL_PHOTOGRAPHY.careerConversation.src} alt="" className="mx-auto mb-4 h-20 w-full max-w-56 rounded-xl object-cover" loading="lazy" decoding="async" aria-hidden="true" />
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                ...
                <div className="text-center">
                  <img src={EDITORIAL_PHOTOGRAPHY.solutionDiscovery.src} alt="" className="mx-auto mb-4 h-20 w-full max-w-56 rounded-xl object-cover" loading="lazy" decoding="async" aria-hidden="true" />
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
