...
const AboutSection: React.FC<AboutSectionProps> = ({ isEnglish }) => {
  ...
  return (
    <section id="about" className="relative py-20 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950">
          ...
          <div>
            ...
            <div className="mt-10">
              <a
                ...
                className="text-blue-800 dark:text-blue-400 font-medium hover:text-blue-900 dark:hover:text-blue-300 transition-colors duration-200 flex items-center"
              >
