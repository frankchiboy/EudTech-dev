      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.78fr_1.22fr] lg:items-start">
          ...
          <div className="grid gap-5 xl:grid-cols-2">
            ...
            <article className="min-w-0 rounded-2xl border border-slate-200 bg-slate-50 p-7 dark:border-slate-800 dark:bg-slate-900">
              <img src="/cyabra-detect-min.png" alt={isEnglish ? 'Cyabra cluster-analysis interface' : 'Cyabra 叢集分析介面'} className="mb-6 aspect-video w-full rounded-xl object-cover" loading="eager" decoding="async" fetchPriority="high" />
