        ...
        <div className="grid gap-12 lg:grid-cols-[0.78fr_1.22fr] lg:items-start">
          ...
          <div className="grid gap-5 xl:grid-cols-2">
            <article className="min-w-0 rounded-2xl border border-slate-200 bg-slate-50 p-7 dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="flex flex-wrap items-center gap-x-3 gap-y-2"><img src="/logo.svg" alt="EudTech" className="h-9 w-auto max-w-full" /><span className="text-2xl font-light text-slate-400">×</span><img src="/comino-grando-logo.png" alt="Comino GRANDO" className="h-11 w-auto max-w-full rounded bg-slate-900 p-2" /></div>
            ...
            <article className="min-w-0 rounded-2xl border border-slate-200 bg-slate-50 p-7 dark:border-slate-800 dark:bg-slate-900">
              <div className="flex flex-wrap items-center gap-x-3 gap-y-2"><img src="/logo.svg" alt="EudTech" className="h-9 w-auto max-w-full" /><span className="text-2xl font-light text-slate-400">×</span><img src="/cyabra-logo.svg" alt="Cyabra" className="h-11 w-auto max-w-full object-contain" /></div>
