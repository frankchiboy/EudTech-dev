      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.78fr_1.22fr] lg:items-start">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <article className="rounded-2xl border border-slate-200 bg-slate-50 p-7 dark:border-slate-800 dark:bg-slate-900">
              <div className="flex items-center gap-4"><img src="/logo.svg" alt="EudTech" className="h-9 w-auto" /><span className="text-2xl font-light text-slate-400">×</span><img src="/cyabra-logo-original.svg" alt="Cyabra" className="h-11 w-auto object-contain" /></div>
