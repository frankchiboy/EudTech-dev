      ...
      <section className="overflow-hidden bg-slate-950 pb-20 pt-32 text-white sm:pb-24">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[0.88fr_1.12fr] lg:items-center lg:px-8">
          <div>
            ...
            <h1 className="mt-5 text-4xl font-bold leading-tight tracking-tight sm:text-5xl lg:text-6xl">{isEnglish ? 'Keep Notion behind the work. Put your brand and workflow in front.' : '保留 Notion 工作方式，客戶看到的是您的品牌與流程'}</h1>
