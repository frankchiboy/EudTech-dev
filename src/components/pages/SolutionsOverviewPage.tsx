...
const SolutionsOverviewPage: React.FC = () => {
  ...
  const items = [
    ...
    {
      icon: Blocks,
      title: { zh: '企業 Headless SaaS 與 AI Agent', en: 'Enterprise headless SaaS and AI agents' },
      ...
      fit: { zh: '適合：企業需要沿用既有系統，同時建立正式的客戶體驗、權限、自動化與服務邊界。', en: 'Best for organisations that need to retain existing systems while adding a formal customer experience, permissions, automation, and service boundaries.' },
  ...
  return <PageShell title={{ zh: 'AI 與數位服務解決方案｜EudTech', en: 'AI and digital service solutions | EudTech' }} description={{ zh: 'EudTech 提供 AI Agent 導入、企業 Headless SaaS、AI 運算基礎設施及社群情報解決方案。', en: 'EudTech provides AI Agent implementation, enterprise headless SaaS, AI infrastructure, and social intelligence solutions.' }} path="/solutions">
