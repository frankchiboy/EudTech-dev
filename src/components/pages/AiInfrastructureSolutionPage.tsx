...
const AiInfrastructureSolutionPage: React.FC = () => {
  ...
  const selectionMatrix = [
    { workload: { zh: '大型模型訓練、微調與高顯存 HPC', en: 'Large-model training, fine-tuning, and high-memory HPC' }, direction: 'NVIDIA H200', memory: '141GB HBM3e / GPU', deployment: { zh: '機架式伺服器、資料中心電力與散熱', en: 'Rack server with data-centre power and cooling' } },
  ...
  return <PageShell title={{ zh: 'AI 運算基礎設施｜EudTech', en: 'AI infrastructure | EudTech' }} description={{ zh: '從工作負載、選型、配置到報價與驗收，建立可採購的 Comino 液冷 AI GPU 運算基礎設施。', en: 'Build quote-ready Comino liquid-cooled AI GPU infrastructure from workload discovery through selection, configuration, quote, and acceptance.' }} path="/solutions/ai-infrastructure">
    <PageHero eyebrow={{ zh: 'AI 運算基礎設施', en: 'AI infrastructure' }} title={{ zh: '先定義工作負載，再決定設備', en: 'Define the workload before choosing the system' }} lead={{ zh: 'EudTech 協助研究室、企業與公部門，把模型、模擬與運算需求轉成可審查、可配置、可詢價及可驗收的液冷 GPU 工作站或伺服器方案。', en: 'EudTech helps labs, enterprises, and public-sector teams turn model, simulation, and compute requirements into reviewable, configurable, quote-ready, and testable liquid-cooled GPU workstation or server plans.' }} isEnglish={isEnglish} image="/vendor/comino/grando-blackwell-official.jpg" imageAlt={VENDOR_EVIDENCE.comino.imageAlt} imagePosition="center" actions={<><ActionLink href="/configurator?request=true">{isEnglish ? 'Open configurator' : '開啟配置器'}</ActionLink><ActionLink href="/contact" secondary>{isEnglish ? 'Discuss a workload' : '討論工作負載'}</ActionLink></>} />
