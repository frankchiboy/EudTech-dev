        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_2fr]">
          <div className="space-y-6">
            ...
            <p className="text-sm leading-6 text-gray-300">
              {isEnglish ? 'EudTech provides the Agent System of Record and Action Layer behind AI interfaces, plus AI infrastructure and social intelligence.' : 'EudTech 提供 AI 使用介面背後的 Agent System of Record + Action Layer，以及 AI 運算基礎設施與社群情報。'}
            </p>
