...
export const CONFIGURATOR_COPY = {
  en: {
    ...
    share: 'Share',
    shareTitleSuffix: 'EudTech Configurator',
    shareText: 'Review this EudTech GPU configuration before requesting a formal quote.',
  ...
  zh: {
    ...
    fixConfig: '修正配置',
    share: '分享',
    shareTitleSuffix: 'EudTech 配置器',
    shareText: '查看這組 EudTech GPU 配置，可用於正式報價前的內部確認。',
    linkCopied: '配置連結已複製。',
