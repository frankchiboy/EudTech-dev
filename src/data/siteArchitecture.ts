...
export const SITE_NAVIGATION_GROUPS: SiteNavigationItem[] = [
  {
    ...
    children: [
      ...
      { id: 'headless-saas', label: { zh: 'Headless SaaS 與 Notion', en: 'Headless SaaS & Notion' }, href: '/solutions/headless-saas', description: { zh: '保留工作層，建立品牌入口、事件與治理。', en: 'Keep the work layer; add a branded experience, events, and governance.' } },
